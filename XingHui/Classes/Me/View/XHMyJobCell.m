...
{
    self.lb_title.text = jobDic[@"com_name"];
    self.lb_time.text=[NSString stringWithFormat:@"%@ ~ %@",jobDic[@"begin_time"],jobDic[@"end_time"]];
    self.lb_postion.text =jobDic[@"job_position"];
