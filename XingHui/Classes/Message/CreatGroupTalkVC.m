...
#import "EaseMob.h"
@interface CreatGroupTalkVC ()<UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UIActionSheetDelegate, BaseTableCellDelegate, SRRefreshDelegate, IChatManagerDelegate>
{
...
@implementation CreatGroupTalkVC
...
- (EMSearchDisplayController *)searchController
{
    if (_searchController == nil) {
        ...
        __weak CreatGroupTalkVC *weakSelf = self;
