...
@interface GroupListViewController ()<UISearchBarDelegate, UISearchDisplayDelegate, IChatManagerDelegate, SRRefreshDelegate,UITableViewDataSource,UITableViewDelegate>
...
//    [self.navigationItem setRightBarButtonItems:@[createGroupItem, publicItem]];
    ...
    [backButton setImage:[UIImage imageNamed:@"bt_return@2x.png"] forState:UIControlStateNormal];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        [chatController setNavtitle:group.groupSubject];
